...
const Hero = () => (
  <div className="container py-12 lg:pb-16">
    <h2 className="text-4xl sm:text-lg font-medium leading-tight tracking-tight text-gray-900">
      We do 3D Matterport Virtual Tour with Basic HDR Photos, DSLR Photos, and
      Drone Photos.
    </h2>
    <h2 className="text-xl sm:text-3xl font-medium leading-tight tracking-tight text-gray-900">
      Pricing for 3D Virtual Tour with Basic HDR Photos:
    </h2>
    <h3 className="text-xl sm:text-2xl font-medium leading-tight tracking-tight text-gray-900 sm:w-4/5 md:w-3/5">
      ...
      <div className="flex flex-row justify-between w-full">
        ...
        <span className="text-blue-600">$180</span>
      </div>
      <div className="flex flex-row justify-between w-full">
        <span>Over 5000 Sq. Ft</span>
        <span className="text-blue-600">Please Inquire</span>
      </div>
    </h3>
    <br />
    <h3 className="text-xl: sm:text-base">
      <span>
      ...
      <br />
      <span>3. All prices may be subject to change without notice.</span>
    </h3>
    <br />
